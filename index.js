...
app.use(api_v01, require("./controllers/routes/eventRoute"));        //event route
app.use(api_v01, require("./controllers/routes/stateRoute"));        //state route
app.use(api_v01, require("./controllers/routes/eventTypeRoute"));    //eventType route
app.use(api_v01, require("./controllers/routes/eventStateRoute"));   //eventState route
